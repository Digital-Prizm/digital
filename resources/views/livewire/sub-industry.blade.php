...
<div>
  ...
  <div class="flex mx-10">
    <div class="w-full max-w-xs mt-6">
      <form name="frmSalutation" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
        ...
        <select id="industry_id" wire:model="industry_id" name="industry_id" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
  ...
  <div class="w-2/3 mx-auto">
    ...
    <div class="mb-4">
        ...
        Select Industry <select id="search_industry_id" wire:model="search_industry_id" wire:change="searchIndustry()" name="search_industry_id" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md">
      ...
      <div class="bg-white shadow-md rounded my-6">
        <table class="text-left w-full border-collapse"> <!--Border collapse doesn't work on this site yet but it's available in newer tailwind versions -->
          <thead>
            <tr>
              <th class="py-4 px-6 bg-grey-lightest font-bold uppercase text-sm text-grey-dark border-b border-grey-light">Sub Industry</th>
          ...
          <tbody>
            ...
            <tr class="hover:bg-grey-lighter">
              ...
              <td class="py-4 px-6 border-b border-grey-light">
                ...
                <a  onclick="javascript:  @this.confirm_function='destroy({{$row->id}})'; @this.confirm_content='Are you sure you want to remove this'; @this.confirm_modal=1; " class="text-grey-lighter font-bold py-1 px-3 cursor-pointer rounded text-xs bg-blue bg-red-500 text-white hover:bg-blue-dark">Remove</a>
              </td>
            </tr>
            @endforeach
            @endif
