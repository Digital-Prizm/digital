...
@endif
  ...
  <div class="flex mx-10">
    <div class="w-full max-w-xs mt-6">
      <form name="frm" class="bg-white rounded px-8 pt-6 pb-8 mb-4">
          @csrf
          ...
          <tbody>
            ...
            <tr class="hover:bg-grey-lighter">
              ...
              <td class="py-4 px-6 border-b border-grey-light">
                ...
                <a  onclick="javascript:  @this.confirm_function='destroy({{$row->id}})'; @this.confirm_content='Are you sure you want to remove this occupation'; @this.confirm_modal=1; " class="text-grey-lighter font-bold py-1 px-3 cursor-pointer rounded text-xs bg-blue bg-red-500 text-white hover:bg-blue-dark">Remove</a>
              </td>
            </tr>
            @endforeach
            @endif
